...
class ModulePageGenerator(PageBase):
    ...
    def generate_page(
        ...
        # Functions/methods are always auto-discovered
    ...
    def _document_module_contents(
        ...
        if explicit_classes:
            classes_to_generate = []
            for child_name in explicit_classes:
    ...
    def _document_children(self, module: Any, children: List[str], module_path: str) -> str:
        ...
        for child_name in children:
            ...
            if inspect.isclass(child):
                classes_to_generate.append((child_name, child))
            elif inspect.isfunction(child) or (
                hasattr(child, "__class__") and "CallableFunction" in child.__class__.__name__
            ):
    ...
    def _document_all_public(self, module: Any, module_path: str, parent_groups: List[str]) -> str:
        ...
        functions = [
            (n, o)
            for n, o in items
            if inspect.isfunction(o) or (hasattr(o, "__class__") and "CallableFunction" in o.__class__.__name__)
        ]
        constants = [
            (n, o)
            for n, o in items
            ...
            and not (hasattr(o, "__class__") and "CallableFunction" in o.__class__.__name__)
        ]
